...
// Function to calculate the average of a student's scores
...
// Function to find a student by ID and print their average score
void showAverageForStudent(const vector<Student>& students) {
    int id;
